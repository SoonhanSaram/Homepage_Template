...
import { playButton, soundButton } from "../css/class";
const MobileVideo = () => {
  ...
  return (
    <div className="flex flex-row m-auto w-[60%] h-[600px]">
      <div className="w-1/2 bg-gray-700">
        <div className="h-full flex flex-col justify-center items-center border-solid border-2 border-white ">
          ...
          <div className="text-white text-lg mb-32">
            <p>소개글을 여기에 적어주세요.</p>
      ...
      <div className="w-1/2 relative ">
        <div className="w-full h-full relative">
          <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center border-solid border-2 border-white">
            <div className="w-[337px] h-[600px] rounded-lg border-4 border-gray-300 overflow-hidden">
              <video
                src="./gopt_home.mp4"
